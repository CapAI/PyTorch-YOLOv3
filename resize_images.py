...
def resize(src='/media/jupyter/PyTorch_YOLOv3/MarineNet-45k/data', size=700):
...
#         dst_dir = os.path.join(src, phase)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--src', type=str, default='/media/jupyter/PyTorch_YOLOv3/MarineNet-45k/data', help='source directory, that contains folders "train/" and "test/".')
